    ...
    if (lostOffsetDirection == 'column') {
      if (lostOffsetNumerator > 0) {
        if (lostOffsetGutter !== '0') {
          decl.cloneBefore({
            prop: 'margin-bottom',
            value: 'calc('+ settings.rounding +'% * '+ lostOffset +' - ('+ lostOffsetGutter +' - '+ lostOffsetGutter +' * '+ lostOffset +') + ('+ lostOffsetGutter +' * 2)) !important'
          });
        } else {
          decl.cloneBefore({
            prop: 'margin-bottom',
            value: 'calc('+ settings.rounding +'% * '+ lostOffset +') !important'
          });
        }
        ...
        if (lostOffsetGutter !== '0') {
          decl.cloneBefore({
            prop: 'margin-top',
            value: 'calc('+ settings.rounding +'% * ('+ lostOffset +' * -1) - ('+ lostOffsetGutter +' - '+ lostOffsetGutter +' * ('+ lostOffset +' * -1)) + '+ lostOffsetGutter +') !important'
          });
        } else {
          decl.cloneBefore({
            prop: 'margin-top',
